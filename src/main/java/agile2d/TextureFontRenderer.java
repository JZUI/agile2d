...
class TextureFontRenderer extends BasicFontRenderer {
    ...
    static int texWidth = 128;
    static int texHeight = 128;
...
//                    continue;
        ...
        public void installImage(GL2 gl) {
            if (image == null)
                return;
    ...
    public void render(
        ...
        glState.glEnable(GL2.GL_TEXTURE_2D);
        ...
        glState.glDisable(GL2.GL_TEXTURE_2D);
    }

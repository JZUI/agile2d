...
public final class AgileGraphics2D extends Graphics2D implements Cloneable, VertexArraySupport {
	...
	/**
	 * Get the size in pixel for the tiles that will be created when drawing an image
	 */
	...
	/**
	 * Display the borders of the tiles generated by Agile2D when drawing an image
	 */
